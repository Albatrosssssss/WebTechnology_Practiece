<?php
  if(isset($_POST['btn'])){
    ...
    $father_tname = $_POST['father_name'];
...
<body>
    <form action="" method="post" novalidate>
          ...
          <input type="text" placeholder="First name" name="fname" id="first_name" ><br>
            <span>
            <?php
          ...
          <input type="text" placeholder="First name" name="lname" id="last_name"  ><br>
            <span>
            <?php
          ...
          <input type="text" placeholder="First name" name="father_name" id="last_name"  ><br>
            <span>
            <?php
          ...
          <input type="text" placeholder="First name" name="mother_name" id="last_name" ><br>
            <span>
            <?php
            ...
            <input type="radio" name="m" id="m" >Male
            <input type="radio" name="m" id="m" >Female
            <input type="radio" name="m" id="m" >Others <br><br>
            <span>
            <?php
            ...
            <fieldset>
                ...
                <input type="number" placeholder="Enter Phone Number" name="number" id="number"  ><br>
                <span>
                <?php
          ...
          <input type="text" placeholder="Enter Website" name="website" id="email" ><br>
            <span>
            <?php
          ...
          <input type="textarea" placeholder="Enter Address" name="address" id="email" ><br>
            <span>
            <?php
          ...
          <input type="tsswordpa" placeholder="Enter Username" name="username" id="psw" ><br>
            <span>
            <?php
